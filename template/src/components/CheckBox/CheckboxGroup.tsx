...
export default class CheckboxGroup extends React.Component<ICheckboxGroupProps, ICheckboxGroupState> {
  static defaultProps = {
    defaultValue: [],
    disabled: false,
    options: [],
  ...
  renderOptions = () => {
    ...
    return options.map((option) => {
      ...
      return (
        <CheckBox {...rest} key={option} value={option} checked={isChecked} onChange={this.handleChange}>
          {option}
        </CheckBox>
      );
    });
